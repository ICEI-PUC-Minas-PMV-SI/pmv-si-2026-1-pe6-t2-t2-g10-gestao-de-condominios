...
<template>
  <div class="min-h-screen px-4 py-4 text-app-primary sm:px-6 lg:px-8">
    <div class="mx-auto mb-4 flex max-w-[1440px] items-center justify-between gap-3 lg:hidden">
      <div class="surface-card flex min-w-0 flex-1 items-center justify-between px-4 py-3">
        <div class="min-w-0">
          ...
          <p class="truncate text-sm font-semibold text-app-primary">
            {{ heading }}
          </p>
        </div>
    ...
    <div class="mx-auto flex min-h-[calc(100vh-2rem)] max-w-[1440px] flex-col gap-4 lg:flex-row">
      ...
      <aside
        class="theme-sidebar fixed inset-y-4 left-4 z-40 flex w-[min(84vw,320px)] flex-col border px-5 py-6 transition duration-200 overflow-hidden lg:static lg:w-[280px] lg:translate-x-0 lg:opacity-100"
        :class="mobileMenuOpen
          ? 'translate-x-0 opacity-100'
          : 'pointer-events-none -translate-x-[115%] opacity-0 lg:pointer-events-auto'"
      >
        <div class="flex h-full flex-col">
          <div class="flex-1 space-y-8 overflow-y-auto pr-1">
            <div
              class="space-y-5 border-b pb-6"
            ...
            >
              <div class="flex items-start justify-between gap-3">
                <div>
                  ...
                  <h1 class="mt-2 font-display text-2xl">
                    Portal
                  </h1>
                </div>
              ...
              <div
                ...
                :style="{
                  ...
                  background: 'var(--secondary-button-inverted-bg)',
                }"
              >
                <p
          ...
          <button
            type="button"
            class="theme-secondary-button mt-4 w-full"
            @click="handleLogout"
          >
            Sair do portal
          </button>
